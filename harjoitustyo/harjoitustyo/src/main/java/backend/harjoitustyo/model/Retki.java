...
public class Retki {
    ...
    @JsonIgnoreProperties("tekijat")
    @ManyToOne
    @JoinColumn(name = "tekija_id")
    private AppUser tekija;
    ...
    public String toString() {
        return "Retki [retkiId=" + retkiId + ", nimi=" + nimi + ", pvm=" + pvm + ", kuvaus=" + kuvaus + ", havainnot="
                + havainnot + ", tekija=" + tekija + "]";
    }
    ...
    public AppUser getTekija() {
        return tekija;
    }

    public void setTekija(AppUser tekija) {
        this.tekija = tekija;
    }
