...
public class RetkiController {
    ...
    public RetkiController(RetkiRepositorio retkiRepositorio, HavaintoRepositorio havaintoRepositorio) {
    ...
    @PostMapping("/saveadd")
    public String saveAdd(@Valid Retki retki, BindingResult bindingResult, Model model) {
